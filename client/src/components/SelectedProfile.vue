  ...
  <q-page class="q-pa-md full-width">
    <div class="flex row q-mb-sm">
      <q-card class="my-card col-8    ">
        <q-card-section class="teal-8">
          <div class="text-h6 text-teal-7">
            {{ this.$store.state.singleGuide.name }}
          </div>
      ...
      <div class="q-pl-sm flex justify-center flex-center column col">
        <q-img
          class="q-mb-sm col full-width rounded-borders"
          v-bind:src="this.$store.state.singleGuide.avatar"
        />
        <q-btn
          class="full-width"
          :loading="loading1"
  ...
  methods: {
    ...
    async startChat() {
      let bookingBody = {
        ...
        details:
          "A tour of Shibuya, Shinjuku and Hachiko for roughly 4 hours. Lunch included.",
        status: "pending",
        conversation: "",
        price: "20000",
        currency: "jpy",
