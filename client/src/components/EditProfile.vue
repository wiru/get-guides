  ...
  <q-page class="q-pa-md full-width">
    ...
    <q-card class="flex row">
        ...
        <q-popup-edit v-model="username" :validate="val => val.length < 20">
          ...
          >
            <q-input
              ...
              :rules="[val => validate(value) || 'Less than 25 chars']"
              @input="emitValue"
            >
      ...
      <q-card-section class="flex justify-center flex-center column col">
        <q-img
          class="col full-width overflow-hidden rounded-borders"
          fit="cover"
          v-bind:src="this.$store.state.guideSelf.avatar"
        >
          <div
            class="flex flex-center bg-grey"
